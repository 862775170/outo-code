...
public class MyAutoGenerator {
    ...
    protected InjectionConfigSupper injectionConfig;
    /**
     * 数据源配置
     */
    ...
    private Map<String, VelocityContext> analyzeData(ConfigBuilder config) {
        ...
        for (TableInfo tableInfo : tableList) {
            ...
            if (null != injectionConfig) {
                ...
                ctx.put("cfg", injectionConfig.getMyMap().get(tableInfo.getName()));
            }
            /* ---------- 添加导入包 ---------- */
    ...
    public MyAutoGenerator setCfg(InjectionConfigSupper injectionConfig) {
